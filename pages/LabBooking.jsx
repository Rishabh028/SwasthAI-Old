...
export default function LabBooking() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col pb-24">
      {/* Header */}
      <div className="bg-gradient-to-r from-orange-600 to-orange-700 text-white px-4 py-6 shadow-lg">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <p className="text-sm font-semibold text-center">Home Collection</p>
          </button>
          ...
          >
            ...
            <p className="text-sm font-semibold text-center">Lab Visit</p>
          </button>
        </div>
      </div>
